...
def register_middleware(app: FastAPI) -> None:
    ...
    app.add_middleware(
        ...
        allow_origin_regex=r"https://molecule-design.*\.vercel\.app|https://.*\.trycloudflare\.com|https://.*\.ngrok-free\.dev|https://.*\.ngrok\.app",
        allow_credentials=True,
        allow_methods=["*"],
        allow_headers=["*"],
        expose_headers=["X-Request-ID", "X-Process-Time", "Content-Disposition", "content-disposition"],
    )
