  ...
  return (
    <section className="rounded-xl border border-blue-800/40 bg-blue-950/20 p-5 text-xs">
      ...
      <ul className="list-disc space-y-1 pl-4 leading-relaxed text-surface-400">
        ...
        <li>
          Se aplica un modelo de <strong className="text-gray-300">re-scoring via Machine Learning</strong> para reducir el ruido de Vina y rescatar la señal biológica del target seleccionado.
        </li>
        <li>
