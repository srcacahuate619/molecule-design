...
const PIPELINE_STEPS = [
  ...
  { step: "06", title: "Rescoring ML (L1)", descPro: "Corrección estadística de afinidad vía XGBoost entrenado con PDBbind.", descEdu: "Los motores físicos tienen sesgos. Para corregirlos, pasamos los resultados por XGBoost, un modelo de Machine Learning entrenado con miles de complejos proteína-ligando reales. Este modelo aprende de los errores históricos y ajusta el puntaje de afinidad, acercándolo con gran precisión a la realidad biológica." },
